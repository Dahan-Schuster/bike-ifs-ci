...
<head>
    ...
    <meta name="description"
        content="Sistema de controle e gerenciamento de entrada e saída de bicicletas do bicicletário do Instituto Federal de Sergipe.">
    <meta name="keywords"
        content="bicicletário, ifs, instituto federal de sergipe, bicicletas, controle de entrada, tecnologia, inovação">
    <link rel="shortcut icon" type="image/x-icon" href="http://bikeifs.com/favicon.ico">
    <link rel="icon" type="image/x-icon" href="http://bikeifs.com/favicon.ico">
    ...
    <script language="javascript" src="http://bikeifs.com/public/lib/scripts/datatables.min.js"></script>
    <script language="javascript" src="http://bikeifs.com/public/lib/scripts/dataTables.responsive.min.js"></script>
    <link rel="stylesheet" type="text/css" href="http://bikeifs.com/public/lib/css/sidepanel.css">
</head>
...
<body>
        ...
        <nav class="navbar sticky-top navbar-expand-xl navbar-light bg-dark header-gradient">
            <div class="container">
                <a class="navbar-brand" href="?pagina=home">
                    <img class='logo' src="http://bikeifs.com/public/img/img-logo.svg" title="Logo" alt="Logo">
                    <img class='logo' src="http://bikeifs.com/public/img/nome-logo.svg" title="Bike IFS" alt="Bike IFS">
                </a>
                <button class="navbar-toggler bg-primary py-2" type="button" data-toggle="collapse"
                    data-target="#navbarMenu" aria-controls="navbarSupportedContent" aria-expanded="false"
                ...
                <div class="collapse navbar-collapse" id="navbarMenu">
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        <li class="nav-item dropdown">
                            <a class="nav-link active dropdown-toggle text-light" id="dropdownMenu"
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenu">
                                <a class="dropdown-item" href="?pagina=perfil">
                                    <span class="py-2 my-2">
                                        <span>Perfil</span>
                                        <img class="ml-3" src="http://bikeifs.com/public/img/icons/profile.png"
                                            title="Perfil" alt="Perfil">
                                    </span>
                                </a>
                                <a class="dropdown-item text-danger" style="font-size: 18px;"
                                    href="http://bikeifs.com/app/src/controller/logout.php">
                                    <span>
                                        <span>Sair</span>
                                        <img style="width: 20px; margin-left: 1.35rem!important;"
                                            src="http://bikeifs.com/public/img/icons/logout.png" title="Sair"
                                            alt="Sair">
                                    </span>
                                </a>
                            </div>
    ...
    <div class="topo">
        <button id="voltar_ao_topo" class="header-gradient" onclick="voltarAoTopo()" title="Voltar ao topo">
            <img src="http://bikeifs.com/public/img/topo.png" alt="topo" class="invert">
        </button>
    </div>
