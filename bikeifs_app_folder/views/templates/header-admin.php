...
<html lang="pt-br">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="http://bikeifs.com/public/lib/css/rowGroup.dataTables.min.css">
        <script language="javascript" src="http://bikeifs.com/public/lib/scripts/dataTables.rowGroup.min.js"></script>
    </head>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenu">
                                    <a class="dropdown-item" href="?pagina=perfil">
                                        ...
                                        <span>Perfil</span>
                                        <img class="ml-3" src="http://bikeifs.com/public/img/icons/profile.png" title="Perfil" alt="Perfil">
                                        </span>
                                    </a>
                                    <a class="dropdown-item text-danger" style="font-size: 18px;" href="http://bikeifs.com/app/src/controller/logout.php">
                                        <span>
                                        <span>Sair</span>
                                        <img style="width: 20px; margin-left: 1.35rem!important;" src="http://bikeifs.com/public/img/icons/logout.png" title="Sair" alt="Sair">
                                        </span>
                                    </a>
                                </div>
                            </li>
